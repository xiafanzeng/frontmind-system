...
export const OPERATOR_MODULES = [
  ...
  { id: "content", label: "内容制作", color: "#8a6100", views: [{ id: "content", label: "内容工作台" }] },
  { id: "publishing", label: "媒体发布", color: "#b33467", views: [{ id: "publishing", label: "发布工作台" }, { id: "articles", label: "稿件" }, { id: "media", label: "媒体库" }] },
  { id: "extensions", label: "项目工具", color: "#5e6174", views: [{ id: "enterprise-qa", label: "企业问答" }, { id: "website", label: "网站管理" }, { id: "content-insights", label: "内容分析与 AI 部件" }] },
] as const;
...
export function canonicalKnowledgeWorkspaceUrl(pathname: string, search: string, hash = ""): string | null {
