...
# FrontMind React Static Company Site Workflow 2.0.0
...
Dashboard supplies one immutable `ReferenceBlueprintV2` derived from the
...
dist.zip, QA and provenance. Private preview remains noindex. Only a
customer-approved build may be re-materialized for its exact canonical hostname
